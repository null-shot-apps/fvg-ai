...
import { Candle, FVG } from '@/types/trading';
...
export default function TradingChart({ candles, fvgs }: TradingChartProps) {
  ...
  // Draw FVG zones
  useEffect(() => {
    if (!chartRef.current || fvgs.length === 0 || !candlestickSeriesRef.current) return;
